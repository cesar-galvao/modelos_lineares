...
Analisaremos o banco de dados `prostate` do pacote `faraway`, em que constam dados de estudo prospectivo com 97 homens com câncer de próstata. 
...
Quando consideramos apenas as covariáveis para as quais temos significância a 5%, ficamos com um modelo final da seguinte forma com $R^2=$ `r round(summary(fit2)$r.squared, 2)`:
